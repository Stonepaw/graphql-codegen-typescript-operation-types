 ...
 * used in the graphql operations. Use one of the typescript or typescript-operation-types, not both.
 *
 * The types generated by this plugin are simple and refer to the exact structure of your schema.
 *
 ...
 */
export interface TypescriptOperationTypesPluginConfig extends Omit<
